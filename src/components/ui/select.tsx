  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        aria-invalid:border-destructive flex h-9 w-fit cursor-pointer items-center justify-between gap-2
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          data-[side=top]:slide-in-from-bottom-2 relative z-50 max-h-96 min-w-[8rem] overflow-hidden
